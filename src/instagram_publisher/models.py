"""Data models for Instagram Publisher."""
...
@dataclass
class ApprovedPost:
    """Represents an Instagram post file approved for publication.

    Attributes:
        file_path: Path to the approval file
        content: The caption text to publish
    ...
    def platform(self) -> str:
        return self.frontmatter.get("platform", "instagram")
...
class PublishResult:
    ...
    def is_retryable(self) -> bool:
        non_retryable = {"SessionExpiredError", "FrontmatterValidationError", "ImageNotFoundError"}

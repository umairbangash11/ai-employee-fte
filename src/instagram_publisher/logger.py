"""Audit logger for Instagram Publisher."""
...
class InstagramLogger:
    """Logs Instagram publish events to JSON lines files in vault/Logs/."""
    ...
    def _get_log_path(self) -> Path:
        ...
        return self.config.logs_dir / f"instagram-{date_str}.log"
    ...
    def log_event(
        ...
        """Write a JSON log line to vault/Logs/instagram-YYYYMMDD.log."""
        event: dict[str, Any] = {
    ...
    def write_vault_log_entry(
        ...
        Fields: timestamp, action_type, source_path, dest_path, outcome, details
        """
    ...
    def log_publishing(self, file_path: Path) -> None:
        self.log_event("publishing", file_path)

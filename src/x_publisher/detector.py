"""File detection for approved X posts.

Monitors vault/Approved/x/ for new files.
Does NOT monitor /Pending_Approval/x/ (safety boundary — FR-003).
"""
...
from x_publisher.exceptions import DetectionError

logger = logging.getLogger(__name__)


class ApprovedFileHandler(FileSystemEventHandler):
    """Watchdog handler for approved X post files."""
...
class XApprovedDetector:
    """Detects approved X posts in vault/Approved/x/."""
